...
class PerfCountersBaseCheck(AgentCheck):
    ...
    def _query_counters(self):
        ...
        try:
            ...
            self.service_check(self.SERVICE_CHECK_HEALTH, self.CRITICAL, message=message, tags=self._static_tags)
        ...
        self.service_check(self.SERVICE_CHECK_HEALTH, self.OK, tags=self._static_tags)
...
class PerfCountersBaseCheckWithLegacySupport(PerfCountersBaseCheck):
    def get_config_with_defaults(self):
        ...
        return super().get_config_with_defaults().new_child(updated_config)
